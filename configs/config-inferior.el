...
;;  Created:    2016-01-28
;;  Language:   Emacs-Lisp
;;  Time-stamp: <2017-03-06 23:38:32 hsiao>
;;  Platform:   Emacs
;;  OS:         GNU
;;  Author:     [hsiao] Jianfang Xiao <xiaojiangang558@gmail.com>
;;
;;  Rights:     Copyright © 2016-2018 Jianfang Xiao, Citi,Shanghai
;;
...
;; (defun hsiao//run-some-python (interpreter &optional dedicated show)
...
;;   (interactive)
;;   (hsiao//run-some-python "python3" nil t))

;; (defun run-python2 ()
;;   "Runs python2 as the inferior python shell"
;;   (interactive)
;;   (hsiao//run-some-python "python2" nil t))

;; (provide 'config-inferior)

;;; Local Variables: ***
;;; mode:Emacs-lisp ***
;;; fill-column: 79 ***
