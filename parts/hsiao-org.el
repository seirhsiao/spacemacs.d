...
(when (string= system-type "darwin")
  ...
  (setq org-mobile-directory "/Users/hsiao/github/iGTD/mobile")
  (setq org-mobile-inbox-for-pull "/Users/hsiao/github/iGTD/from-mobile.org"))

;; 设置capture的模版
(setq org-capture-templates
      '(
        ("a" "Account" table-line
         (file+headline "~/work/github/eden/pass/pass.org" "Web accounts")
         "| %? | | %a | %U |")
        ...
        ("c" "Calendar" entry (file+headline (expand-file-name org-default-notes-file org-directory) "Calendar")
         "* %?\n  创建于:%T\n")
        ("j" "Journal" entry (file+datetree "~/work/org/journal.org")
         "* %?\nEntered on %U\n  %i\n  %a")
...
(setq hsiao-gtd-files (list (expand-file-name "finished.org" org-directory)
